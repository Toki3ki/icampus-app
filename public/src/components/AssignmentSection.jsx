...
const initialAssignments = [
  {
    ...
    completed: false,
    deadline: '2025-06-20T17:00:00' // 添加 deadline (格式: YYYY-MM-DDTHH:mm:ss)
  },
  {
    id: 2,
    course: 'Physics 201',
    ...
    completed: false,
    deadline: '2025-06-25T17:00:00' // 添加 deadline
  },
];
...
function AssignmentSection() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (currentAssignment.course && currentAssignment.task && currentAssignment.deadline) {
      if (editingId) {
        // 更新现有任务
